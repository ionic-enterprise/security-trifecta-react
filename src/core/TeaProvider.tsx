...
// import { useTastingNotesDatabase } from '../utils/tasting-notes-database';
// import { useTeaCategoriesDatabase } from '../utils/tea-categories-database';
...
const TeaProvider: React.FC<Props> = ({ children }) => {
    ...
    return <TeaContext.Provider value={{ teas, rate, refresh, teaCategories, saveTea, remove, syncTeas, refreshCategories, refreshTastingNotes}}>{children}</TeaContext.Provider>
}
