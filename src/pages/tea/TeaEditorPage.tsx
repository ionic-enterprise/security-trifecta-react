import { IonButton, IonButtons, IonContent, IonFooter, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonModal, IonPage, IonSelect, IonSelectOption, IonTextarea, IonTitle, IonToggle, IonToolbar } from '@ionic/react';
        ...
        <>
            ...
            <IonContent>
                <IonList>
                    ...
                    <IonItem>
                        <IonSelect label='Type' name='teaCategoryId' value={teaCategory?.id} onIonChange={e => updateCategory(e.detail.value)}>
            ...
            <IonFooter>
                <IonToolbar>
                    <IonButton disabled={checkDisabled()} expand='full' onClick={submit}>{!newTea ? 'Update' : "Add"}</IonButton>
                </IonToolbar>
            </IonFooter>
        </>
    )
